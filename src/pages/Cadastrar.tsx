    ...
    <div className="min-h-screen w-full relative flex items-center justify-center bg-[#f4f7fe] dark:bg-[#0b1329] p-4 transition-colors duration-300">
      ...
      <div className="w-full max-w-md bg-white dark:bg-[#111c44] rounded-2xl shadow-xl shadow-gray-200/50 dark:shadow-none p-8 border border-gray-100 dark:border-[#1e2d60] transition-colors duration-300 relative">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-semibold text-[#1b2559] dark:text-gray-300 mb-1.5">Nome Completo</label>
            <input
              type="text"
              required
          ...
          <div>
            <label className="text-sm font-semibold text-[#1b2559] dark:text-gray-300 block mb-1.5">Senha</label>
            <input
          ...
          <div>
            <label className="block text-sm font-semibold text-[#1b2559] dark:text-gray-300 mb-1.5">Confirme sua Senha</label>
            <input
              type={showPassword ? 'text' : 'password'}
              required
